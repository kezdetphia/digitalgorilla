...
const perks = [
  {
    ...
    description:
      "Get your assets delivered to your email in seconds and download them straight away",
  },
  {
    name: "Guaranteed Quality",
    Icon: CheckCircle,
    description:
      "Every asset on our platform is verified by out team to ensure our highest quality standards. Not happy? We offer a 30-day refund guarantee",
  },
  {
    name: "For the Planet",
    Icon: Leaf,
  ...
  return (
    <>
      <MaxWidthWrapper>
        ...
        <ProductReel title="brand new" href="/prodcuts" />
